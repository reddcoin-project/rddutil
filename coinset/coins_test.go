...
import (
	...
	"github.com/reddcoin-project/rddutil/coinset"
	"github.com/reddcoin-project/rddwire"
	"github.com/conformal/fastsha256"
)

type TestCoin struct {
	TxHash     *rddwire.ShaHash
	TxIndex    uint32
	TxValue    rddutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *rddwire.ShaHash { return c.TxHash }
func (c *TestCoin) Index() uint32          { return c.TxIndex }
func (c *TestCoin) Value() rddutil.Amount  { return c.TxValue }
...
func NewCoin(index int64, value rddutil.Amount, numConfs int64) coinset.Coin {
	h := fastsha256.New()
	h.Write([]byte(fmt.Sprintf("%d", index)))
	hash, _ := rddwire.NewShaHash(h.Sum(nil))
	c := &TestCoin{
		TxHash:     hash,
		TxIndex:    0,
		TxValue:    value,
...
var (
	...
	testSimpleCoinTxValue0            = rddutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = rddutil.NewTxFromBytes(testSimpleCoinTxBytes)
